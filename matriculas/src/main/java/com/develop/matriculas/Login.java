...
public class Login extends javax.swing.JFrame {
    ...
    void consultar() {
        String sql = "select * from alumno_datos_basicos";
        ...
        while (modelo.getRowCount() > 0) {
            ...
            while (rs.next()) {
                ...
                estudiante[1] = rs.getString("Nombres");
                estudiante[2] = rs.getString("Apellido_Materno");
                estudiante[3] = rs.getString("Apellido_Paterno");
                estudiante[4] = rs.getInt("DNI");
