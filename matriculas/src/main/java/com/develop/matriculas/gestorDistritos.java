 ...
 * @author estrosebas
 */
public class gestorDistritos extends javax.swing.JFrame {

    /**
     * Creates new form gestorDistritos
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gestorDistritos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gestorDistritos().setVisible(true);
            }
        });
    }
